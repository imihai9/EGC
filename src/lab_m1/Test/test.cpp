...
void Test::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        vector<unsigned int> indices =
        {
            ...
            1, 0, 3,    // indices for first triangle
    ...
    // 12 vertices -> in order to apply a different color for each face
    {
        vector<VertexFormat> vertices
        {
            // Vertices data for the tetrahedron mesh
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 1)),   //0
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 0)),   //1
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0, 1)),   //2

            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 1, 0)),   //3
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 0)),   //4
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 0, 1)),   //5

            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 1, 1)),   //6
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1, 1, 0)),   //7
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1, 0, 1)),   //8

            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 1)),   //9
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(1, 1, 0)),   //10
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 0))    //11
        };

        vector<unsigned int> indices =
        {
            //Indices data for the tetrahedron mesh
            2, 5, 8,
            0, 6, 9,
            1, 11, 4,
            3, 10, 7
...
void Test::CreateMesh(const char *name, const std::vector<VertexFormat> &vertices, const std::vector<unsigned int> &indices)
{
    unsigned int VAO = 0;
...
void Test::Update(float deltaTimeSeconds)
{
    glLineWidth(3);
    glPointSize(5);
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(2, 0.5f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(-3, 1.5f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1, 0, 0), glm::vec3(0.25f));
...
void Test::OnInputUpdate(float deltaTime, int mods)
{
}
...
void Test::OnMouseMove(int mouseX, int mouseY, int deltaX, int deltaY)
{
    // Add mouse move event
}


void Test::OnMouseBtnPress(int mouseX, int mouseY, int button, int mods)
{
    // Add mouse button press event
}


void Test::OnMouseBtnRelease(int mouseX, int mouseY, int button, int mods)
{
    // Add mouse button release event
}


void Test::OnMouseScroll(int mouseX, int mouseY, int offsetX, int offsetY)
{
}
